...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='eventify.organization@gmail.com')

# Use Gmail SMTP when credentials are set. Otherwise console email backend.
